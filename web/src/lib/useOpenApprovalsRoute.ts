...
/**
 * Routes to `/access` when a NEW desktop "open-approvals" signal arrives — i.e. when the monotonic
 ...
 * Access on every tab switch (a navigation trap). Tracking the last-handled count in a ref makes
